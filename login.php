...
global $wpdb;
 ...
 if(isset($_POST['login_user_pass']))
 {
  ...
  if( $username == "" || $password == "" ) {
   ...
   if ( is_wp_error($user) ) {
    $err = "Please check your email/username and password.";
    wp_redirect(home_url("login?e=" . $err));
    exit();
   } else {
...
<?php //$user_info = get_user_by('login','admin');
//$user_info = wp_get_current_user();

// $user_location = get_user_meta( 3, 'location', true ); 
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                    ...
                    <?php if(!isset($_GET['step'])) { ?>
                        ...
                        <div class="text-center mt-6 mb-4">
                            <a onclick="loginwithusernameDiv()" class="text-center text-dark " style="font-weight: 600;" href="#"><i class="fas fa-long-arrow-alt-right"></i> Login with email/username and password</a>
                        </div>
                    ...
                    <div class="text-center">
                        <a id="register_start_modal_btn" class="text-center btn btn-link text-danger mt-6" href="#">Don't have an account? Signup here</a>

                        <a class="text-center btn btn-link text-danger mt-4" href="">Forgot your password?</a>
