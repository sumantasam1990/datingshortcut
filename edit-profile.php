...
$mob = get_user_meta($current_user->ID, 'mob', true);
$datewith = get_user_meta($current_user->ID, 'datewith', true);
$bank = get_user_meta($current_user->ID, 'bank', true);
$addr = get_user_meta($current_user->ID, 'addr', true);
...
if ( 'POST' == $_SERVER['REQUEST_METHOD'] && isset($_POST['save_changes']) ) {
    ...
    if($_POST['mob_num'] != '') {
        update_user_meta( $current_user->ID, 'mob', sanitize_text_field($_POST['mob_num']) );
    }
    update_user_meta( $current_user->ID, 'datewith', sanitize_text_field($_POST['date_with']) );
    update_user_meta( $current_user->ID, 'bank', sanitize_text_field($_POST['bank']) );
    update_user_meta( $current_user->ID, 'addr', sanitize_text_field($_POST['addr']) );

    if(sanitize_text_field($_POST['my_price']) > 49) {
        update_user_meta( $current_user->ID, 'my_price', (float) sanitize_text_field($_POST['my_price']) );
    } else {
...
if ( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['action'] ) && $_POST['action'] == 'update-user' ) {
    ...
    if ( is_wp_error( $img_id ) ) {
      echo $img_id->get_error_message();
        ...
        $wpdb->update( $usertablename, array( 'photo_status' => 0),array('ID'=>$loggedin_user->ID));
        ...
        <div class="container mb-4">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-3">
                    ...
                    <?php
                    if($loggedin_user->photo_status == 0) {
                        echo '<p class="mb-3 fw-bold badge bg-danger fs-6"><i class="fas fa-hourglass-half"></i> Pending for approval.</p>';
                    } elseif ($loggedin_user->photo_status == 1) {
                        echo '<p class="mb-3 fw-bold badge bg-danger fs-6"><i class="far fa-times-circle"></i> Rejected. <br />Please upload your another photo.</p>';
                    } else {
                        //
                    }
                    ?>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <?php } else { ?>
                            ...
                            <a href="<?php echo home_url() ?>/verified" class="btn btn-danger btn-lg mt-2"><i class="far fa-check-circle"></i> Get Verified</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input required style="border-top-left-radius: 0px !important; border-bottom-left-radius: 0px !important;" class="form-control" type="text" min="50" name="my_price" placeholder="Eg. 100" value="<?php echo (isset($my_price) ? number_format($my_price, 2) : '70.00'); ?>">
                            ...
                            <?php if($mob == '') { ?>
                                <div class="form-group mt-4">
                                    <label style="text-align: left !important;" class="text-uppercase text-left mb-2 fw-bold">Mobile Number*</label>
                            ...
                            <?php } else { ?>
                                <div class="form-group mt-6">
                                    ...
                                    <input disabled type="text" class="form-control" placeholder="" value="<?php echo (isset($mob) ? $mob : ''); ?>">
                                </div>
                            <?php } ?>

                            <label class="mb-2 mt-3" style="font-weight: 700;">Personal Address</label>
                            <div class="input-group">


                                <input required  class="form-control" type="text" name="addr" placeholder="Your Personal Address" value="<?php echo (isset($addr) ? $addr : ''); ?>">

                            </div>

                            <label class="mb-2 mt-3" style="font-weight: 700;">Bank Account</label>
                            <div class="input-group">


                                <textarea required  class="form-control" type="text" name="bank" placeholder="Enter your bank details." ><?php echo (isset($bank) ? $bank : ''); ?></textarea>

                            </div>

                            <label class="mb-2 mt-3" style="font-weight: 700;">Sexual Preference</label>
                            <div class="">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <button style="float: right;" name="save_changes" type="submit" class="btn btn-dark btn-lg otp_veri">Save Changes</button>
                    </div>
                </div>
            </div>
